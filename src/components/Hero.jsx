  ...
  return (
    <Section className='pt-[12rem] -mt-[5.25rem]' crosses crossesOffset='lg:translate-y-[5.25rem]' customPaddings id="hero">
        <div className='container relative' ref={parallaxRef}>
            <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mg-20 lg:mb:[6rem]'>
                <h1 className='h1 mb-6'>
                    Explore the Possibilities of&nbsp;Studying&nbsp;Online with {` `}
                ...
                <p className='body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8 pt-12'>
                    Unleash the power of AI within BrainWave. 
                    Upgrade your productivity with Brainwave, 
                    the open AI study app
                </p>
                ...
                <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        ...
                        <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                <Notification className="hidden absolute -right-[5.5rem] bottom-[11rem] w-[18rem] xl:flex" title="Problem Generation"/>
                            </ScrollParallax>
                        </div>
